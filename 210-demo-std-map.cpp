...
int main() {
    ...
    villagerDetails["Audie"] = {5, "Human", "Howdy partner!"};
    villagerDetails["Raymond"] = {3, "Werewolf", "I'm not a wolf, I promise."};
    villagerDetails.insert({"Marshal", {10, "Human", "This place is so cool!"}});
